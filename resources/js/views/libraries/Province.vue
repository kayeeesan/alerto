...
const headers = [
    ...
    { title: "Region", key: "region.name", width: "40%" },
...
const deleteItem = async (value) => {
    await destoryProvince(value.id); // Swal handled in composable
};
...
<template>
    <v-container fluid class="pa-6">
        <v-row class="mb-4" align="center">
            <v-col cols="12" md="6">
                <h2 class="text-h5 font-weight-bold">Provinces Management</h2>
                <v-breadcrumbs :items="[{ title: 'Settings', disabled: true }, { title: 'Provinces' }]" class="pa-0"></v-breadcrumbs>
            </v-col>
